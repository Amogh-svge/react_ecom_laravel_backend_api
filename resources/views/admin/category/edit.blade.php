...
@section('main_content')
    <div>
        ...
        <x-app-layout>
            ...
            <form enctype="multipart/form-data" action="{{ route('category.update', $category->id) }}" class="form-inputs my-3"
                method="POST">
                @csrf
                @method('PUT')
                ...
                <div class="row row-sm p-4">
                    <div class="col-lg-12 my-2">
                        ...
                        <input name="category_name" class="invalid  w-100 " placeholder="Enter Category Name" type="text"
