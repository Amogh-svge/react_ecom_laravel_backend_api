    ...
    <form enctype="multipart/form-data" action={{ route('category.store') }} class="form-inputs my-3" method="POST">
        ...
        <div class="row row-sm p-4">
            <div class="col-lg-12 my-2">
                ...
                <input name="category_name" class="invalid  w-100 " placeholder="Enter Category Name" value="{{ old('category_name') }}" type="text">
            ...
            <div class="col-lg mg-t-10 mg-lg-t-0 my-2">
                ...
                <div class="custom-file">
                    <input name="category_image" onchange="getpath" type="file" class="custom-file-input" id="customFile">
            ...
            <div class="my-2">
                <img style=" width:100px; height:100px; box-shadow: rgba(0, 0, 0, 0.24) 0px 3px 8px;" id="showImage" src="{{ url('img/no-image.png') }}" class="rounded-full">
            </div>
